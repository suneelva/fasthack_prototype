...
describe("ImmutableQuery", function () {
    ...
    it("supports multiple queries added", function () {
        var query = _this.addQuery();
        query = query.addQuery(_1.BoolMust(_1.TermQuery("active", true)));
        query = query.addQuery(_1.BoolMust([
            _1.TermQuery("published", true),
            _1.TermQuery("archived", false)
        ]));
    ...
    it("addAnonymousFilter()", function () {
        var mockId = "123";
        spyOn(_1.Utils, "guid").and.returnValue(mockId);
