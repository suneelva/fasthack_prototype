...
describe("BucketAggregations", function () {
    ...
    it("GeoboundsBucket", function () {
        _this.aggs = _1.GeoboundsBucket(_this.aggsKey, "location", { precision: 5 }, _this.childBucket);
        _this.expectAggs({ geo_bounds: { field: "location", precision: 5 } });
    });
    it("DateHistogramBucket", function () {
        expect(_1.DateHistogramBucket(_this.aggsKey, "date_field")).toEqual((_a = {},
            _a[_this.aggsKey] = {
                date_histogram: { field: "date_field" }
            },
            _a));
        _this.aggs = _1.DateHistogramBucket(_this.aggsKey, "date_field", { interval: "year" }, _this.childBucket);
        _this.expectAggs({ date_histogram: { field: "date_field", interval: "year" } });
        var _a;
    });
});
