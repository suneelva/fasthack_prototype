...
describe("NumericOptionsAccessor", function () {
    ...
    it("buildOwnQuery()", function () {
        ...
        expect(query.query.aggs).toEqual(_1.FilterBucket("categories1", _1.BoolMust([_1.BoolShould(["foo"])]), _1.RangeBucket("categories", "price", [
            {
                "key": "All"
            },
            {
    ...
    describe("Nested usecase", function () {
        ...
        it("buildOwnQuery()", function () {
            ...
            var query = _this.accessor.buildSharedQuery(_this.query);
            query = _this.accessor.buildOwnQuery(query);
            expect(query.query.aggs).toEqual(_1.FilterBucket("categories1", _1.BoolMust([_1.BoolShould(["foo"])]), _1.NestedBucket("inner", "nestedPrice", _1.RangeBucket("categories", "price", [
                {
                    "key": "All"
                },
                {
