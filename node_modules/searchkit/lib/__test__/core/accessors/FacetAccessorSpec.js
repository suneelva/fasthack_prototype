...
describe("FacetAccessor", function () {
    beforeEach(function () {
        ...
        _this.accessor = new _1.FacetAccessor("genreKey", _this.options);
        _this.accessor.setSearchkitManager(_1.SearchkitManager.mock());
    });
    it("constructor()", function () {
        expect(_this.accessor.options).toBe(_this.options);
        expect(_this.accessor.urlKey).toBe("GenreId");
        expect(_this.accessor.key).toBe("genreKey");
    });
    ...
    it("getBuckets() - non string keys", function () {
        expect(_this.accessor.getBuckets()).toEqual([]);
        _this.accessor.results = {
            aggregations: {
                genreKey1: {
        ...
        expect(_this.accessor.getBuckets())
            .toBe(_this.accessor.getRawBuckets());
        _this.accessor.state = _this.accessor.state.setValue(["1", "true", "6"]);
        expect(_this.accessor.getBuckets())
            .toEqual([
    ...
    describe("buildOwnQuery", function () {
        ...
        it("build own query - or", function () {
            ...
            expect(query.query.aggs).toEqual(_1.FilterBucket("genreKey1", _1.BoolMust([
                _1.BoolShould(["PG"])
        ...
        describe("NestedFieldContext", function () {
            ...
            it("buildSharedQuery", function () {
                ...
                _this.query = new _1.ImmutableQuery()
                    .addFilter("rating_uuid", _1.BoolShould(["PG"]));
                _this.query = _this.accessor.buildSharedQuery(_this.query);
                expect(_this.query.index.filtersMap["genreKey1"]).toEqual(_1.BoolShould([
            ...
            it("buildOwnQuery", function () {
                ...
                expect(_this.query.query.aggs).toEqual(_1.FilterBucket("genreKey1", _1.BoolShould(["PG"]), _1.NestedBucket("inner", "tags", _1.TermsBucket("genre", "genre", { size: 20 }), _1.CardinalityMetric("genre_count", "genre"))));
            });
            it("getBuckets()", function () {
                expect(_this.accessor.getBuckets()).toEqual([
                    { key: '1' }, { key: '2' }
