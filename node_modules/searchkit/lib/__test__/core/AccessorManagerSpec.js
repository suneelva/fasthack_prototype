...
var _1 = require("../../");
var StatelessPageAccessor = /** @class */ (function (_super) {
...
describe("AccessorManager", function () {
    beforeEach(function () {
        _this.accessors = new _1.AccessorManager();
        _this.accessor1 = new _1.PaginationAccessor("p1");
        _this.accessor2 = new _1.PaginationAccessor("p2");
        _this.accessors.add(_this.accessor1);
        _this.accessors.add(_this.accessor2);
        ...
        _this.accessors.add(_this.accessor3);
        _this.accessors.add(_this.accessor4);
        _this.accessors.add(_this.accessor4b);
        _this.accessor5 = new StatelessPageAccessor(50);
        _this.accessors.add(_this.accessor5);
    });
    ...
    it("add() incompatible access with same key", function () {
        var queryAccessor = new _1.QueryAccessor("q");
        expect(_this.accessors.add(queryAccessor)).toBe(queryAccessor);
        expect(function () { return _this.accessors.add(new _1.PaginationAccessor("q")); }).toThrow("Multiple imcompatible components with id='q' existing on the page");
    });
    it("add() - QueryAccessor and then remove", function () {
        ...
        expect(function () { return accessors.add(queryAccessor); }).toThrow("Only a single instance of BaseQueryAccessor is allowed");
